...
const { User, Product, Order, Category, Promotion, Favorite} = sequelize.models;
...
User.belongsToMany(Product, {as: 'UserFavorites',through: 'UserProduct'});
Product.belongsToMany(User, {as: 'UserFavorites', through: 'UserProduct'});
